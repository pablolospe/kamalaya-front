...
const Formulario = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col items-center md:mx-auto p-4 bg-gray-100 rounded-lg shadow-md w-full"
    >
      <div
      ...
      >
        ...
        <div className="p-4 md:max-w-3xl gap-2 shadow-lg rounded-lg w-full">
          <label>
            Nombre/s:
            <input
              required
        ...
        <div className="flex flex-col w-full p-4 gap-2 shadow-lg rounded-lg">
